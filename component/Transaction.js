...
class Transaction extends Component{
    ...
    render(){
        const styles = StyleSheet.create({
            body:{
                flexDirection:'row',
                height:(this.props.parentList!=0)?((this.props.label.length>30)?60:30):30,
                minWidth:'70%',
                display:
            ...
            <View style={styles.body} >
                ...
                >
                    <Text
                        ...
                        style = {{color:(this.props.list.amount>0)?'green':'#b90000',
                        fontWeight:'bold',paddingLeft:(this.props.parentList!=0)?'10%':'3%'}}
                    >
                        {"* "+this.props.label+" "+((this.props.list.amount>0)?'+'+
                        this.props.list.amount:this.props.list.amount)}
                    </Text>
                </TouchableOpacity>
                {
